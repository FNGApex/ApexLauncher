...
- Azure `client_id` is `00000000402b5328` — the official public Minecraft launcher client ID (constant `MS_CLIENT_ID` in `auth.rs:18`). Source documented in code comment.
