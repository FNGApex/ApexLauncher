...
- `src-tauri/src/core/mod_install_tests.rs` (1164 lines) — 26 unit tests using `MockProvider` (VecDeque-backed) and `MockProviderClient`, wired back via the `#[path]` stub
