...
- `src-tauri/src/core/task_manager_tests.rs` (584 lines) — 11 unit tests (all `#[tokio::test]`): FIFO ordering, cancel-queued, cancel-running, snapshot counts, `finish_done_with_result` payload, observer full-lifecycle; wired via `#[path]` stub
