...
`/refresh-signals` (dispatches the `atomic-signals-inferrer` agent). Nine domains today:
**instances**, **metadata**, **download**, **resolver**, **java**, **launch**, **auth**, **frontend-shell**, **providers**.
