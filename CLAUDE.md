...
`/refresh-signals` (dispatches the `atomic-signals-inferrer` agent). Ten domains today:
**instances**, **metadata**, **download**, **resolver**, **java**, **launch**, **auth**, **frontend-shell**, **providers**, **mod-install**.
