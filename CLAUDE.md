...
`/refresh-signals` (dispatches the `atomic-signals-inferrer` agent). Thirteen domains today:
**instances**, **metadata**, **download**, **task-manager**, **resolver**, **java**, **launch**, **auth**, **frontend-shell**, **providers**, **mod-install**, **modpack**, **launcher-import**.
...
that imports modpacks from **CurseForge, Modrinth, FTB, and ATLauncher**, and imports existing
instances from **Prism Launcher / MultiMC / PolyMC**.
