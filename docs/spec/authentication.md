...
| ~~Mojang approval of our client_id~~ — resolved | Approved 2026-06-11 | Azure app approved; `login_with_xbox` succeeds. Default client ID is the registered `modloader` Azure app (`DEFAULT_MS_CLIENT_ID`, env-overridable via `MODLOADER_MS_CLIENT_ID`); see docs/design/auth-client-id-blocker.md. |
